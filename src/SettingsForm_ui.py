...
class Ui_SettingsForm(object):
    def setupUi(self, SettingsForm):
        ...
        self.relay_capture_left_edit = QPlainTextEdit(self.groupBox)
        self.relay_capture_left_edit.setObjectName(u"relay_capture_left_edit")
        sizePolicy.setHeightForWidth(self.relay_capture_left_edit.sizePolicy().hasHeightForWidth())
        self.relay_capture_left_edit.setSizePolicy(sizePolicy)
        self.relay_capture_left_edit.setMinimumSize(QSize(0, 31))
        self.relay_capture_left_edit.setMaximumSize(QSize(16777215, 31))
        self.relay_capture_left_edit.setTabChangesFocus(True)

        self.verticalLayout_4.addWidget(self.relay_capture_left_edit)

        self.relay_capture_top_edit = QPlainTextEdit(self.groupBox)
        self.relay_capture_top_edit.setObjectName(u"relay_capture_top_edit")
        sizePolicy.setHeightForWidth(self.relay_capture_top_edit.sizePolicy().hasHeightForWidth())
        self.relay_capture_top_edit.setSizePolicy(sizePolicy)
        self.relay_capture_top_edit.setMinimumSize(QSize(0, 31))
        self.relay_capture_top_edit.setMaximumSize(QSize(16777215, 31))
        self.relay_capture_top_edit.setTabChangesFocus(True)

        self.verticalLayout_4.addWidget(self.relay_capture_top_edit)

        self.relay_capture_width_edit = QPlainTextEdit(self.groupBox)
        self.relay_capture_width_edit.setObjectName(u"relay_capture_width_edit")
        sizePolicy.setHeightForWidth(self.relay_capture_width_edit.sizePolicy().hasHeightForWidth())
        self.relay_capture_width_edit.setSizePolicy(sizePolicy)
        self.relay_capture_width_edit.setMinimumSize(QSize(0, 31))
        self.relay_capture_width_edit.setMaximumSize(QSize(16777215, 31))
        self.relay_capture_width_edit.setTabChangesFocus(True)

        self.verticalLayout_4.addWidget(self.relay_capture_width_edit)

        self.relay_capture_height_edit = QPlainTextEdit(self.groupBox)
        self.relay_capture_height_edit.setObjectName(u"relay_capture_height_edit")
        sizePolicy.setHeightForWidth(self.relay_capture_height_edit.sizePolicy().hasHeightForWidth())
        self.relay_capture_height_edit.setSizePolicy(sizePolicy)
        self.relay_capture_height_edit.setMinimumSize(QSize(0, 31))
        self.relay_capture_height_edit.setMaximumSize(QSize(16777215, 31))
        self.relay_capture_height_edit.setTabChangesFocus(True)

        self.verticalLayout_4.addWidget(self.relay_capture_height_edit)

        self.relay_capture_monitor_edit = QPlainTextEdit(self.groupBox)
        self.relay_capture_monitor_edit.setObjectName(u"relay_capture_monitor_edit")
        sizePolicy.setHeightForWidth(self.relay_capture_monitor_edit.sizePolicy().hasHeightForWidth())
        self.relay_capture_monitor_edit.setSizePolicy(sizePolicy)
        self.relay_capture_monitor_edit.setMinimumSize(QSize(0, 31))
        self.relay_capture_monitor_edit.setMaximumSize(QSize(16777215, 31))
        self.relay_capture_monitor_edit.setTabChangesFocus(True)

        self.verticalLayout_4.addWidget(self.relay_capture_monitor_edit)
...
#if QT_CONFIG(tooltip)
        self.relay_capture_left_edit.setToolTip(QCoreApplication.translate("SettingsForm", u"Left coordinate (pixels) of the capture region", None))
#endif // QT_CONFIG(tooltip)
        self.relay_capture_left_edit.setPlaceholderText(QCoreApplication.translate("SettingsForm", u"Capture Region Left", None))
#if QT_CONFIG(tooltip)
        self.relay_capture_top_edit.setToolTip(QCoreApplication.translate("SettingsForm", u"Top coordinate (pixels) of the capture region", None))
#endif // QT_CONFIG(tooltip)
        self.relay_capture_top_edit.setPlaceholderText(QCoreApplication.translate("SettingsForm", u"Capture Region Top", None))
#if QT_CONFIG(tooltip)
        self.relay_capture_width_edit.setToolTip(QCoreApplication.translate("SettingsForm", u"Width (pixels) of the capture region", None))
#endif // QT_CONFIG(tooltip)
        self.relay_capture_width_edit.setPlaceholderText(QCoreApplication.translate("SettingsForm", u"Capture Region Width", None))
#if QT_CONFIG(tooltip)
        self.relay_capture_height_edit.setToolTip(QCoreApplication.translate("SettingsForm", u"Height (pixels) of the capture region", None))
#endif // QT_CONFIG(tooltip)
        self.relay_capture_height_edit.setPlaceholderText(QCoreApplication.translate("SettingsForm", u"Capture Region Height", None))
#if QT_CONFIG(tooltip)
        self.relay_capture_monitor_edit.setToolTip(QCoreApplication.translate("SettingsForm", u"Monitor index for the capture region (0 = entire desktop)", None))
#endif // QT_CONFIG(tooltip)
        self.relay_capture_monitor_edit.setPlaceholderText(QCoreApplication.translate("SettingsForm", u"Capture Region Monitor", None))
